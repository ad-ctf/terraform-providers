...
1. Open https://cloud.digitalocean.com/account/api/tokens/new
2. Specify token name (any of your choice) and expiration.
3. Scopes: Custom Scopes. Select "droplet" checkbox (create, read, update, delete, admin permissions).
4. Click "Generate Token". Required scopes will be prompted, click "continue".
5. Copy generated token, specify in `digitalocean_api_token` module input.
...
c5-2vcpu-4gb                CPU Intensive 5x SSD                        4096       2        125     62.00            0.092260
...
g6_5-2vcpu-8gb              General Purpose 6.5x SSD                    8192       2        163     90.60            0.134820
g5_5-2vcpu-8gb-intel        General Purpose - Premium Intel 5.5x SSD    8192       2        165     92.20            0.137200
...
c5-4vcpu-8gb                CPU Intensive 5x SSD                        8192       4        250     124.00           0.184520
...
c5-4vcpu-8gb-intel          CPU Optimized - Premium Intel 5x SSD        8192       4        250     161.00           0.239580
...
g6_5-4vcpu-16gb             General Purpose 6.5x SSD                    16384      4        325     181.00           0.269350
g5_5-4vcpu-16gb-intel       General Purpose - Premium Intel 5.5x SSD    16384      4        330     183.40           0.272920
...
c5-8vcpu-16gb               CPU Intensive 5x SSD                        16384      8        500     248.00           0.369050
...
c5-8vcpu-16gb-intel         CPU Optimized - Premium Intel 5x SSD        16384      8        500     322.00           0.479170
...
g6_5-8vcpu-32gb             General Purpose 6.5x SSD                    32768      8        650     362.00           0.538690
g5_5-8vcpu-32gb-intel       General Purpose - Premium Intel 5.5x SSD    32768      8        660     366.80           0.545830
...
c5-16vcpu-32gb              CPU Intensive 5x SSD                        32768      16       1000    496.00           0.738100
...
c5-16vcpu-32gb-intel        CPU Optimized - Premium Intel 5x SSD        32768      16       1000    645.00           0.959820
...
g6_5-16vcpu-64gb            General Purpose 6.5x SSD                    65536      16       1300    724.00           1.077380
g5_5-16vcpu-64gb-intel      General Purpose - Premium Intel 5.5x SSD    65536      16       1320    734.60           1.093150
...
c5-32vcpu-64gb              CPU Intensive 5x SSD                        65536      32       2000    992.00           1.476190
...
c5-32vcpu-64gb-intel        CPU Optimized - Premium Intel 5x SSD        65536      32       2000    1290.00          1.919640
...
g6_5-32vcpu-128gb           General Purpose 6.5x SSD                    131072     32       2600    1448.00          2.154760
c2-48vcpu-96gb-intel        Premium Intel                               98304      48       1200    1466.00          2.181550
g5_5-32vcpu-128gb-intel     General Purpose - Premium Intel 5.5x SSD    131072     32       2640    1469.20          2.186310
gpu-mi300x1-192gb           AMD MI300X - 1X                             245760     20       720     1480.56          1.990000
c5-48vcpu-96gb              CPU Intensive 5x SSD                        98304      48       3000    1488.00          2.214290
...
g6_5-40vcpu-160gb           General Purpose 6.5x SSD                    163840     40       3250    1810.00          2.693450
...
c5-48vcpu-96gb-intel        CPU Optimized - Premium Intel 5x SSD        98304      48       3000    1934.00          2.877980
...
g5_5-48vcpu-192gb-intel     General Purpose - Premium Intel 5.5x SSD    196608     48       3960    2202.80          3.277980
...
c5-60vcpu-120gb-intel       CPU Optimized - Premium Intel 5x SSD        122880     60       3750    2419.00          3.599700
...
g5_5-60vcpu-240gb-intel     General Purpose - Premium Intel 5.5x SSD    245760     60       4950    2755.00          4.099700
...
```
$ doctl --output=json compute image ls --public | jq -r '.[] | select(.type == "base") | [ .distribution, .name, .slug ] | @tsv' | column -ts $'\t'
Rocky Linux  9 x64                           rockylinux-9-x64
Rocky Linux  8 x64                           rockylinux-8-x64
Ubuntu       22.04 (LTS) x64                 ubuntu-22-04-x64
Ubuntu       25.04 x64                       ubuntu-25-04-x64
Ubuntu       24.04 (LTS) x64                 ubuntu-24-04-x64
AlmaLinux    AlmaLinux 10                    almalinux-10-x64
CentOS       9 Stream x64                    centos-stream-9-x64
Rocky Linux  10 x64                          rockylinux-10-x64
Fedora       42 x64                          fedora-42-x64
Debian       13 x64                          debian-13-x64
CentOS       10 Stream x64                   centos-stream-10-x64
Debian       12 x64                          debian-12-x64
AlmaLinux    AlmaLinux 9                     almalinux-9-x64
AlmaLinux    AlmaLinux 8                     almalinux-8-x64
Ubuntu       NVIDIA AI/ML Ready              gpu-h100x1-base
Ubuntu       NVIDIA AI/ML Ready with NVLink  gpu-h100x8-base
Ubuntu       25.10 x64                       ubuntu-25-10-x64
Ubuntu       AMD AI/ML Ready Image           gpu-amd-base
Fedora       43 x64                          fedora-43-x64
```